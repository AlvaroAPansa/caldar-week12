...
export const ENDPOINT_BUILDINGS = `${BACKEND_URL}/buildings`;
export const ENDPOINT_CUSTOMERS = `${BACKEND_URL}/customers`;
export const ENDPOINT_TECHNICIANS = `${BACKEND_URL}/technicians`;
